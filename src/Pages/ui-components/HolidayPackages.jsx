...
const tours = [
  ...
  },
  {
    ...
    price: '₹15,500/pa',
    image: 'https://images.unsplash.com/photo-1516910914652-5d9a42ff4a5d?auto=format&fit=crop&w=1200&q=80',
    stats: [
    ...
    <section className="w-full bg-white md:px-0 px-4 py-16 sm:py-14">
      ...
      <div className=" text-center mb-12">
        <h1 className="heading text-5xl font-bold leading-tight text-[#1a1a1a] tracking-tight">
          Holiday <span className="text-[var(--green)] heading">Packages</span>
        </h1>
        <p className="mt-4 text-[#6b7280] text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
          Not sure where to go? We've got you covered with guided and self-guided
          tours across the most iconic routes in Ladakh.
        </p>
      </div>
